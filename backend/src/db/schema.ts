...
export const orders = mysqlTable("Order", {
  ...
  shippingStatus: varchar("shippingStatus", { length: 191 }),
  shippingRawResponse: json("shippingRawResponse"),
  shippingLastCheckedAt: datetime("shippingLastCheckedAt", { fsp: 3 }),
...
export const returnRequests = mysqlTable("ReturnRequest", {
  ...
  returnWaybill: varchar("returnWaybill", { length: 191 }),

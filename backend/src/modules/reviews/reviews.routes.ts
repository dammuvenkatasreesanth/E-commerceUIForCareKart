...
import { reviewHelpfulLimiter } from "../../middleware/rateLimit.middleware";
...
reviewsRouter.patch("/:id/helpful", reviewHelpfulLimiter, asyncHandler(controller.markHelpful));

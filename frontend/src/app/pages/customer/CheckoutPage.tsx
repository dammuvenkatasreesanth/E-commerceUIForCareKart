...
function CheckoutWizard() {
  ...
  // Set the instant an order is placed and never reset — unlike isPlacing
  // (which flips back to false in a render that can land before the
  // post-order navigate actually takes hold), this reliably disables the
  // empty-cart redirect below for the rest of this checkout session, however
  // many renders happen in between placing the order and leaving this page.
  ...
  useEffect(() => {
    if (buyNow || cartLoading || orderPlacedRef.current) return;

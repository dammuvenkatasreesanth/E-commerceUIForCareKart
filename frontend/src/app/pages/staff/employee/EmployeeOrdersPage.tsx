...
import { useEmployeeOrders } from "../../../hooks/useEmployee";
import type { EmployeeOrderListQuery } from "../../../lib/api/endpoints/employee";
...
export function EmployeeOrdersPage() {
  ...
  const query: EmployeeOrderListQuery = {
    q: q || undefined,
  ...
  const { data, isLoading } = useEmployeeOrders(query);

  const goToOrder = (o: AdminOrder) => navigate(`/staff/employee/orders/${o.id}`);
